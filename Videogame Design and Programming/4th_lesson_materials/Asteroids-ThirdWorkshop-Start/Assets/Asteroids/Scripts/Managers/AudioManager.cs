...
public class AudioManager : Singleton<AudioManager>
{
    ...
    IEnumerator PlayBackgroundCoroutine()
    {
        while (true)
        {
            _backgroundMusic.PlayOneShot(_asteroidSoundBank.QuietBeat);
            yield return new WaitForSeconds(_asteroidSoundBank.QuietBeatTiming);
        }
    }

    public void StopBackgroundMusic()
    {
        StopCoroutine("PlayBackgroundMusicCoroutine");
    }
    */
